...
import com.sandbox.myhal.adapters.MemberListItemsAdapter
...
class MembersActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.hasExtra(Constants.BOARD_DETAIL)){
            ...
            mCustomerCatalog.getAssignedMembersListDetails(
    ...
    fun memberDetails(user: User){
        ...
        mBoardCatalog.assignMemberToBoard(this, mBoardDetails, user)
    }
    ...
    The resource will be inflated, adding all top-level views to the screen.*/
        ...
        dialog.tv_add.setOnClickListener(View.OnClickListener {
            ...
            if (email.isNotEmpty()) {
                dialog.dismiss()
                showProgressDialog(resources.getString(R.string.please_wait))
                mCustomerCatalog.getMemberDetails(this, email)
            } else {
                Toast.makeText(
    ...
    fun memberAssignSuccess(user: User){
        ...
        SendNotificationToUserAsycTask(mBoardDetails.name, user.fcmToken).execute()
    }

    private inner class SendNotificationToUserAsycTask(
